          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                ...
                <span className="font-mono text-sm text-gray-400 flex items-center gap-2 mt-2 md:mt-0">
                  <Calendar className="w-4 h-4" />
                  June 2025 – Aug 2025
                </span>
              </div>
              <p className="font-mono text-lg text-white mb-4">Qureal AI</p>
        ...
        <div className="mt-12">
          ...
          <div className="border border-[hsl(var(--kali-green))/0.3] rounded-lg p-6 bg-card/50">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-2">
              <h4 className="font-mono text-lg font-bold text-white">B.Tech in Computer Science and Engineering</h4>
              <span className="font-mono text-sm text-gray-400 flex items-center gap-2 mt-2 md:mt-0">
                <Calendar className="w-4 h-4" />
                August 2022 – July 2026
              </span>
            </div>
            <p className="text-gray-400 mb-3">University Institute of Technology RGPV Bhopal</p>
